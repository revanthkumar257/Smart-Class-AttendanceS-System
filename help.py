...
class Help:
    def __init__(self, root):
        ...
        img_top = Image.open(r"C:\Users\Uday Bolla\OneDrive\Desktop\BTP NANDINI\smart-class-attendence-system\images\images\help.jpeg")
        ...
        dev_label = Label(f_lbl, text="EMAIL: pathivadanandini24@gmail.com", font=("times new roman", 20, "bold"), fg="blue", bg="white")
